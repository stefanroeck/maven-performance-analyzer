...
export const InputSelector: FC = () => {
    ...
    return (<>
        ...
        <Paper elevation={2} sx={{ padding: "20px" }}>
            <InputText onSelected={setAnalyzerInput} visible={inputType === "text"} disabled={isBusy} />
            <InputFile onSelected={setAnalyzerInput} visible={inputType === "file"} disabled={isBusy} />
            <InputUrl onSelected={setAnalyzerInput} visible={inputType === "url"} disabled={isBusy} />
