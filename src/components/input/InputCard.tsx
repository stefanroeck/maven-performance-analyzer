...
export const InputCard: FC = () => {
  ...
  return (
    <ExpandableCard
      title="Provide Maven Log"
      subheader={
        "The file can either be pasted as text, selected from disk or read from a url. All data will be processed on the client only, nothing will be uploaded to a server."
      }
      expanded={true}
    >
      <InputSelector />
